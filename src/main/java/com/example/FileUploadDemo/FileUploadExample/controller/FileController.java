package com.example.FileUploadDemo.FileUploadExample.controller;

import com.example.FileUploadDemo.FileUploadExample.service.FileService;
    ...
    public String uploadFile(@RequestParam("file")MultipartFile file,
        ...
        if(file.isEmpty()){
            ...
            redirectAttributes.addFlashAttribute("message", "You successfully" +
                    " uploaded " + file.getOriginalFilename() + "!, file." );
